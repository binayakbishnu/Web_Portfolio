                    ...
                    <ReactBootstrap.Container className={`${navStyles.bStrapContainer}`}>
                        ...
                        <ReactBootstrap.Navbar.Collapse id="responsive-navbar-nav">
                            <ReactBootstrap.Nav className="me-auto">
                                ...
                                <ReactBootstrap.Nav.Link href={this.props.scrollLinks === "webdev" ? "webdev/#certificationswebdev" : "#certifications"} className={`${navStyles.links} ${navStyles.leftLinks}`} style={{ "display": `${this.props.navDisplay}` }}>Certifications</ReactBootstrap.Nav.Link>
